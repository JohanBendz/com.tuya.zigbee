...
const V1_THERMOSTAT_DATA_POINTS = {
    ...
    preset: 2, // enum | 0: manual, 1: auto, 2: holiday
...
// Data points for air quality detection devices
const V1_AIR_QUALITY_DATA_POINTS = {
    formaldehyde: 12, // Integer | Formaldehyde level
...
const V1_MOTION_SENSOR_DATA_POINTS = {
    ...
    pirSensitivity: 9, // integer | sensitivity level (e.g., 1-100)
    pirTime: 10, // integer | time in seconds before motion resets (motion inactive time)
    illuminanceValue: 12 // integer | ambient light level in lux
};
