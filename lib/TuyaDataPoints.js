...
const V2_MULTI_GANG_DIMMER_SWITCH_DATA_POINTS = {
    onOffGangOne: 1, // Boolean | On/Off control for first gang
    brightnessGangOne: 2, // Integer | Brightness level for first gang | 0-1000 scale
    minimumBrightnessGangOne: 3, // Integer | Minimum brightness level for first gang | 0-1000 scale
    maximumBrightnessGangOne: 5, // Integer | Maximum brightness level for first gang | 0-1000 scale
    countdownGangOne: 6, // Integer | Countdown timer for first gang | 0-43200 seconds
    onOffGangTwo: 7, // Boolean | On/Off control for second gang
    brightnessGangTwo: 8, // Integer | Brightness level for second gang | 0-1000 scale
    minimumBrightnessGangTwo: 9, // Integer | Minimum brightness level for second gang | 0-1000 scale
    maximumBrightnessGangTwo: 11, // Integer | Maximum brightness level for second gang | 0-1000 scale
    countdownGangTwo: 12, // Integer | Countdown timer for second gang | 0-43200 seconds
    onOffGangThree: 15, // Boolean | On/Off control for third gang
    brightnessGangThree: 16, // Integer | Brightness level for third gang | 0-1000 scale
    minimumBrightnessGangThree: 17, // Integer | Minimum brightness level for third gang | 0-1000 scale
    maximumBrightnessGangThree: 19, // Integer | Maximum brightness level for third gang | 0-1000 scale
    countdownGangThree: 20, // Integer | Countdown timer for third gang | 0-43200 seconds
    powerOnStatusSetting: 14, // Enum | Power on status setting | Off, On, Memory
    backlightMode: 21 // Enum | Backlight mode | Off, Normal, Inverted
...
module.exports = {
    ...
    V2_MULTI_GANG_DIMMER_SWITCH_DATA_POINTS,
