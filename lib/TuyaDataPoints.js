...
const V1_FINGER_BOT_DATA_POINTS = {
    switch: 1, // Boolean | 0: off, 1: on
    mode: 101, // Enum | 0: click, 1: switch, 2: program
    lower: 102, // Integer | 50-100 (%), Down movement limit 
    delay: 103, // Integer | 0-10 (s), Sustain / hold time
    reverse: 104, // Boolean | 0: normal, 1: reverse, Movement direction
    battery: 105, // Integer | 0-100 (%), Battery level
    upper: 106, // Integer | 0-50 (%), Up movement limit
    touch: 107 // Boolean | Touch sensor enabled, 0: disabled, 1: enabled
};
