 ...
 * - Datapoint Zigbee2MQTT: https://github.com/Koenkk/zigbee-herdsman-converters/blob/master/src/devices/tuya.ts#L2711-L2742
...
class ThermostaticRadiatorValve extends TuyaSpecificClusterDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.registerCapabilityListener("target_temperature", async (value, opts) => {
      // TODO: do not allow change when window is open
