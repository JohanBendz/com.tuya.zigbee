...
/*     debug(true);
    this.enableDebug(); */
        ...
        this.registerCapabilityListener('target_temperature', async (targetTemperature) => {
            // Tuya reports and expects the setpoint in tenths of a degree.
            await this.writeData32(THERMOSTAT_DATA_POINTS.targetTemperature, Math.round(targetTemperature * 10));
    ...
    async processResponse(data) {
        ...
        switch (dp) {
            ...
            case THERMOSTAT_DATA_POINTS.mode:
                ...
                try {
                    await this.setCapabilityValue('thermostat_programming', parsedValue.toString());
                } catch (e) {
